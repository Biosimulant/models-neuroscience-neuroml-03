#!/usr/bin/env python3
"""Run generated space: neuroscience-cortical-circuits-combo-0073."""
...
def _repo_root_map(current_repo_root: Path) -> dict[str, Path]:
    ...
    return {
        "Biosimulant/models-neuroscience-neuroml-03": current_repo_root.resolve(),
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'neuroscience-cortical-circuits-combo-0073')} duration={duration} tick_dt={tick_dt}")
